package com.test.tableau.config;
...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.test.tableau.Controller"))
...
//				.contact(new Contact("MR Wu", "127.0.0.1", "375006985@qq.com"))
//				.version("1.0")
//				.build();
//
//	}
